...
${indent}columns: ${matrix.columns}
  ...
  function characteristics(t, r) {
      ...
      res.lm_gaussian = levenbergMarquardt({ x: res.t, y: res.r }, gaussian, {
          damping: 1.5,
          initialValues: [res.r_mms.max, _t0, _s]
      });

      res.lm_asym_lorentzian = levenbergMarquardt({ x: res.t, y: res.r }, asym_lorentzian, {
          damping: 1.5,
  ...
  exports.asym_lorentzian = asym_lorentzian;
  ...
  exports.smoothat = smoothat;
  exports.smoothto = smoothto;
  exports.t_array_from_to = t_array_from_to;
